...
## This is a streamlit app.py file
...
st.write("Welcome to Appy Chatbot! Ask any question related to Apple Cultivation  and I'll do my best to help you.")
st.write("#### Built with 🤗 Ctransformers, Langchain, and Pinecone VectorDB. Powered by Metal-llama2-7b-chat quantized LLM")
st.write("##### Resource Used 📖 : Books,Research Papers, Case Studies, and Articles related to Apple Cultivation")
...
<div class="footer">
    ...
    <p> <p style="text-align:center;">Made with ❤️ by <a href="https://www.adarshmaurya.onionreads.com">Team Solve-Ease</a></p> </p>
</div>
""", unsafe_allow_html=True)
